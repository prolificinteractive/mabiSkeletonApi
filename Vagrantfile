...
Vagrant.configure('2') do |config|
  ...
  config.vm.synced_folder ".", "/var/www/#{confVals['api']['appName']}"
  ...
  config.vm.provision :puppet, :module_path => "vagrant/puppet/modules" do |puppet|
    ...
    puppet.facter = {
      "useDocs" => confVals['api']['docsPort'],
      "dbName"  => confVals['api']['dbName'],
      "appName" => confVals['api']['appName'],
    }
  end
